package com.landsky.sound.service;
...
public class SendSms {
    ...
    public void send(String phone,String code) throws Exception{
        ...
        String appKey = "egzyK8MFJtE8UMIKj4j2y48Xvrd1"; //APP_Key
        String appSecret = "U87HRi98KC8fQpu5w77QAtiVQWCX"; //APP_Secret
        String sender = "88191024280"; //国内短信签名通道号或国际/港澳台短信通道号
        String templateId = "18b4fb140a0e415ea54851b26914580d"; //模板ID
